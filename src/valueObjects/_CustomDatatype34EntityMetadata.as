...
[ExcludeClass]
internal class _CustomDatatype34EntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("id", "unit", "isVisible", "modelName", "isOutputIndicator", "hasSplitByPwr", "hasSplitByDevices", "hasSplitByTypes", "hierarchy", "hasTimeSeries", "namen", "comments");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "unit", "isVisible", "modelName", "isOutputIndicator", "hasSplitByPwr", "hasSplitByDevices", "hasSplitByTypes", "hierarchy", "hasTimeSeries", "namen", "comments");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "unit", "isVisible", "modelName", "isOutputIndicator", "hasSplitByPwr", "hasSplitByDevices", "hasSplitByTypes", "hierarchy", "hasTimeSeries", "namen", "comments");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "unit", "isVisible", "modelName", "isOutputIndicator", "hasSplitByPwr", "hasSplitByDevices", "hasSplitByTypes", "hierarchy", "hasTimeSeries", "namen", "comments");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "CustomDatatype34";
    ...
    model_internal var _modelNameIsValid:Boolean;
    model_internal var _modelNameValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _modelNameIsValidCacheInitialized:Boolean = false;
    model_internal var _modelNameValidationFailureMessages:Array;
    ...
    model_internal var _instance:_Super_CustomDatatype34;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _CustomDatatype34EntityMetadata(value : _Super_CustomDatatype34)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["isVisible"] = new Array();
            model_internal::dependentsOnMap["modelName"] = new Array();
            model_internal::dependentsOnMap["isOutputIndicator"] = new Array();
            model_internal::dependentsOnMap["hasSplitByPwr"] = new Array();
        ...
        model_internal::_modelNameValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForModelName);
        model_internal::_modelNameValidator.required = true;
        model_internal::_modelNameValidator.requiredFieldError = "modelName is required";
        //model_internal::_modelNameValidator.source = model_internal::_instance;
        //model_internal::_modelNameValidator.property = "modelName";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::dataProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity CustomDatatype34");  
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity CustomDatatype34");  
    ...
    override public function getValue(propertyName:String):*
    {
        ...
        {
            throw new Error(propertyName + " does not exist for entity CustomDatatype34");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isIsVisibleAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isModelNameAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isHasSplitByPwrAvailable():Boolean
    {
        return true;
    }
    ...
    public function invalidateDependentOnModelName():void
    {
        if (model_internal::_modelNameIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfModelName = null;
            model_internal::calculateModelNameIsValid();
        }
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get isVisibleStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get modelNameStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    public function get modelNameValidator() : StyleValidator
    {
        return model_internal::_modelNameValidator;
    }

    model_internal function set _modelNameIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_modelNameIsValid;         
        if (oldValue !== value)
        {
            model_internal::_modelNameIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "modelNameIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get modelNameIsValid():Boolean
    {
        if (!model_internal::_modelNameIsValidCacheInitialized)
        {
            model_internal::calculateModelNameIsValid();
        ...
        return model_internal::_modelNameIsValid;
    }

    model_internal function calculateModelNameIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_modelNameValidator.validate(model_internal::_instance.modelName)
        model_internal::_modelNameIsValid_der = (valRes.results == null);
        model_internal::_modelNameIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::modelNameValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::modelNameValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get modelNameValidationFailureMessages():Array
    {
        if (model_internal::_modelNameValidationFailureMessages == null)
            model_internal::calculateModelNameIsValid();

        return _modelNameValidationFailureMessages;
    }

    model_internal function set modelNameValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_modelNameValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_modelNameValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "modelNameValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
    ...
    [Bindable(event="propertyChange")]   
    public function get hasSplitByPwrStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("modelName"):
            {
                return modelNameValidationFailureMessages;
            }
            case("hierarchy"):
            {
