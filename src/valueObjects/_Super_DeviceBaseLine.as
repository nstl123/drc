 ...
 * of this value object you may modify the generated sub-class of this class - DeviceBaseLine.as.
 */
...
[ExcludeClass]
public class _Super_DeviceBaseLine extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _DeviceBaseLineEntityMetadata;
    ...
    private var _internal_Y2003 : Number;
    private var _internal_Y2002 : Number;
    private var _internal_Y2001 : Number;
    private var _internal_Y2025 : Number;
    private var _internal_Y2024 : Number;
    private var _internal_Y2023 : Number;
    private var _internal_Y2022 : Number;
    private var _internal_Y2021 : Number;
    private var _internal_Y2020 : Number;
    private var _internal_Y2000 : Number;
    ...
    public function _Super_DeviceBaseLine()
    {
        _model = new _DeviceBaseLineEntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get Y2003() : Number
    {
        return _internal_Y2003;
    }

    [Bindable(event="propertyChange")]
    public function get Y2002() : Number
    {
        return _internal_Y2002;
    }

    [Bindable(event="propertyChange")]
    public function get Y2001() : Number
    {
        return _internal_Y2001;
    }

    [Bindable(event="propertyChange")]
    public function get Y2025() : Number
    {
        return _internal_Y2025;
    }

    [Bindable(event="propertyChange")]
    public function get Y2024() : Number
    {
        return _internal_Y2024;
    }

    [Bindable(event="propertyChange")]
    public function get Y2023() : Number
    {
        return _internal_Y2023;
    }

    [Bindable(event="propertyChange")]
    public function get Y2022() : Number
    {
        return _internal_Y2022;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get Y2000() : Number
    {
        return _internal_Y2000;
    }
    ...
    public function set Y2003(value:Number) : void
    {
        var oldValue:Number = _internal_Y2003;
        if (isNaN(_internal_Y2003) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Y2003 = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Y2003", oldValue, _internal_Y2003));
        }
    }

    public function set Y2002(value:Number) : void
    {
        var oldValue:Number = _internal_Y2002;
        if (isNaN(_internal_Y2002) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Y2002 = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Y2002", oldValue, _internal_Y2002));
        }
    }

    public function set Y2001(value:Number) : void
    {
        var oldValue:Number = _internal_Y2001;
        if (isNaN(_internal_Y2001) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Y2001 = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Y2001", oldValue, _internal_Y2001));
        }
    }

    public function set Y2025(value:Number) : void
    {
        var oldValue:Number = _internal_Y2025;
        if (isNaN(_internal_Y2025) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Y2025 = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Y2025", oldValue, _internal_Y2025));
        }
    }

    public function set Y2024(value:Number) : void
    {
        var oldValue:Number = _internal_Y2024;
        if (isNaN(_internal_Y2024) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Y2024 = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Y2024", oldValue, _internal_Y2024));
        }
    }

    public function set Y2023(value:Number) : void
    {
        var oldValue:Number = _internal_Y2023;
        if (isNaN(_internal_Y2023) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Y2023 = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Y2023", oldValue, _internal_Y2023));
        }
    }

    public function set Y2022(value:Number) : void
    {
        var oldValue:Number = _internal_Y2022;
        if (isNaN(_internal_Y2022) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Y2022 = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Y2022", oldValue, _internal_Y2022));
        }
    }
    ...
    public function set Y2000(value:Number) : void
    {
        var oldValue:Number = _internal_Y2000;
        if (isNaN(_internal_Y2000) == true || Math.abs(oldValue - value) > epsilon)
        {
            _internal_Y2000 = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "Y2000", oldValue, _internal_Y2000));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DeviceBaseLineEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DeviceBaseLineEntityMetadata) : void
    {
        var oldValue : _DeviceBaseLineEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
