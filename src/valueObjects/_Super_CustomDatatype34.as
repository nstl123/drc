 ...
 * of this value object you may modify the generated sub-class of this class - CustomDatatype34.as.
 */
...
[ExcludeClass]
public class _Super_CustomDatatype34 extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CustomDatatype34EntityMetadata;
    ...
    private var _internal_isVisible : int;
    private var _internal_modelName : Object;
    private var _internal_isOutputIndicator : int;
    private var _internal_hasSplitByPwr : int;
    ...
    public function _Super_CustomDatatype34()
    {
        _model = new _CustomDatatype34EntityMetadata(this);
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "modelName", model_internal::setterListenerModelName));
    ...
    [Bindable(event="propertyChange")]
    public function get isVisible() : int
    {
        return _internal_isVisible;
    }

    [Bindable(event="propertyChange")]
    public function get modelName() : Object
    {
    ...
    [Bindable(event="propertyChange")]
    public function get hasSplitByPwr() : int
    {
        return _internal_hasSplitByPwr;
    }
    ...
    public function set isVisible(value:int) : void
    {
        var oldValue:int = _internal_isVisible;
        if (oldValue !== value)
        {
            _internal_isVisible = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "isVisible", oldValue, _internal_isVisible));
        }
    }

    public function set modelName(value:Object) : void
    {
        var oldValue:Object = _internal_modelName;
        if (oldValue !== value)
        {
            _internal_modelName = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "modelName", oldValue, _internal_modelName));
        }
    }
    ...
    public function set hasSplitByPwr(value:int) : void
    {
        var oldValue:int = _internal_hasSplitByPwr;
        if (oldValue !== value)
        {
            _internal_hasSplitByPwr = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "hasSplitByPwr", oldValue, _internal_hasSplitByPwr));
        }
    }
    ...
    model_internal function setterListenerModelName(value:flash.events.Event):void
    {
        _model.invalidateDependentOnModelName();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.modelNameIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_modelNameValidationFailureMessages);
        }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CustomDatatype34EntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CustomDatatype34EntityMetadata) : void
    {
        var oldValue : _CustomDatatype34EntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationCacheOfModelName : Array = null;
    model_internal var _doValidationLastValOfModelName : Object;

    model_internal function _doValidationForModelName(valueIn:Object):Array
    {
        var value : Object = valueIn as Object;

        if (model_internal::_doValidationCacheOfModelName != null && model_internal::_doValidationLastValOfModelName == value)
           return model_internal::_doValidationCacheOfModelName ;

        _model.model_internal::_modelNameIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isModelNameAvailable && _internal_modelName == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "modelName is required"));
        }

        model_internal::_doValidationCacheOfModelName = validationFailures;
        model_internal::_doValidationLastValOfModelName = value;
