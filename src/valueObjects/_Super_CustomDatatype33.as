 ...
 * of this value object you may modify the generated sub-class of this class - CustomDatatype33.as.
 */
...
[ExcludeClass]
public class _Super_CustomDatatype33 extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CustomDatatype33EntityMetadata;
    ...
    public function _Super_CustomDatatype33()
    {
        _model = new _CustomDatatype33EntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get chemistryID() : int
    {
        return _internal_chemistryID;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get deviceName() : Object
    {
    ...
    public function set chemistryID(value:int) : void
    {
        var oldValue:int = _internal_chemistryID;
        if (oldValue !== value)
        {
            _internal_chemistryID = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "chemistryID", oldValue, _internal_chemistryID));
        }
    }
    ...
    public function set deviceName(value:Object) : void
    {
        var oldValue:Object = _internal_deviceName;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CustomDatatype33EntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CustomDatatype33EntityMetadata) : void
    {
        var oldValue : _CustomDatatype33EntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfDeviceName : Object;
