 ...
 * of this value object you may modify the generated sub-class of this class - CustomDatatype31.as.
 */
...
[ExcludeClass]
public class _Super_CustomDatatype31 extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CustomDatatype31EntityMetadata;
    ...
    private var _internal_modified : int;
    ...
    public function _Super_CustomDatatype31()
    {
        _model = new _CustomDatatype31EntityMetadata(this);
    ...
    [Bindable(event="propertyChange")]
    public function get modified() : int
    {
    ...
    public function set modified(value:int) : void
    {
        var oldValue:int = _internal_modified;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CustomDatatype31EntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CustomDatatype31EntityMetadata) : void
    {
        var oldValue : _CustomDatatype31EntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
