 ...
 * of this value object you may modify the generated sub-class of this class - DeviceName.as.
 */
...
[ExcludeClass]
public class _Super_DeviceName extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _DeviceNameEntityMetadata;

    /**
     * properties
     */
    private var _internal_id : int;
    private var _internal_hierarchy : int;
    ...
    public function _Super_DeviceName()
    {
        _model = new _DeviceNameEntityMetadata(this);
    ...
    public function set hierarchy(value:int) : void
    {
        var oldValue:int = _internal_hierarchy;
        if (oldValue !== value)
        {
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DeviceNameEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DeviceNameEntityMetadata) : void
    {
        var oldValue : _DeviceNameEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
